...
Built-ins cover Claude Code, Codex, Cursor, and Grok. Generic tools are declared in server config with an executable, argv template, and accepted argument definitions.
